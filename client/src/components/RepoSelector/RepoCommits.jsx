        ...
        <div className="mt-2 max-h-[570px] overflow-y-auto pt-2 scrollbar">
          ...
          <ul className="space-y-2 pr-2">
            {commits.map((commit, index) => (
              <li
                key={index}
                className="border border-gray-200 p-6 rounded-lg hover:shadow-lg transition-shadow duration-300 ease-in-out hover:border-[#50D890] bg-white"
              >
                ...
                <div className="flex flex-col md:flex-row  mt-6 md:mt-2 items-center justify-end gap-4">
                  <a
                    ...
                    className="flex items-center gap-2 pl-4 pr-3 py-2.5 rounded-xl font-normal hover:bg-[#50D890] bg-[#50D890] text-[#1e1c1e] -colors duration-1000 ease-in-out w-full md:w-auto"
                  >

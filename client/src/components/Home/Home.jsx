...
const Home = () => {
  ...
  return (
    <main id="home" className="w-full flex justify-center items-center pt-24 md:pt-40">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-between h-full">
              <div className="space-y-6 mb-8 md:mb-16">
                ...
                <p className="text-gray-600 text-lg sm:text-xl leading-relaxed max-w-lg">
                  We&apos;re an AI-powered code review platform that integrates with
                  GitHub, providing automated insights to improve code quality
                  and help developers write better code with every commit.
                </p>
              </div>
                  ...
                  <div className="group w-full sm:w-auto">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-xs sm:text-sm text-gray-600 font-medium">
                        100+ users improving their code
                      </span>
                    </div>
                  </div>
                </div>

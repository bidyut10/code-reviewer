  ...
  return (
    <div className="w-full h-[750px]">
      <div className=" bg-white/50 backdrop-blur-sm rounded-2xl overflow-hidden shadow-xl h-2/3 w-full">
        ...
        <div className="mt-4 p-4 md:p-6 space-y-4 md:space-y-6">
            ...
            <div className="space-y-4 transition-opacity duration-300">
              <div className="bg-white/40 backdrop-blur-sm rounded-lg p-4 border border-gray-200 transition-all duration-300">
                <div className="flex items-center justify-between mb-3">
                  ...
                  {connected && (
                    <div className="flex items-center gap-1 text-[#c1ff72] text-xs font-normal">
                ...
                <p className="text-xs">
                  Connect your GitHub account to get started with automated code
                  reviews
                </p>
                <div className="mt-4">
                  {!connecting && !connected ? (
                    ...
                    <div className="flex items-center gap-2 text-xs text-[#c1ff72]">
                      <svg
                        className="w-4 h-4"
                        fill="currentColor"
                        viewBox="0 0 20 20"
            ...
            <div className="space-y-4 transition-opacity duration-300">
              <div className="bg-white/40 backdrop-blur-sm rounded-lg p-4 border border-gray-200 transition-all duration-300">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="font-normal text-sm">Select Repository</span>
                </div>
